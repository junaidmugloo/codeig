...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="/about">Insert</a>
  </li>
  <li class="nav-item">
      ...
      <div class="col-md-9">
        <form action="javascript:void(0)" name="ajax_form" id="ajax_form" method="post" accept-charset="utf-8">
          ...
          <div class="form-group">
            ...
            <input type="password" name="message"  placeholder="Please enter password" class="form-control"></textarea>
